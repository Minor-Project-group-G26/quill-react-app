...
function AdminVerifyInstructor() {
        ...
        <View key={index} style={[style.rectangle, index %2 != 0?style.color2:{}]}>
            ...
            <View style={style.rightBox}>
                ...
                <TouchableOpacity style={style.Delete}>
                    <Image style={{height:21,width:21}} source={require('../../assets/icons/Delete.png')} />
                </TouchableOpacity>   
            </View>
        </View>
    ))
    return (
        <View style={style.box1}>
            <View style={style.header}>
                <RText style={{fontFamily:'Roboto-Bold', fontSize:18}}>Instructors</RText>
            </View>
...
export default RootComponent(AdminVerifyInstructor, false)
